<template>
  <div>
    ...
    >
      <div
        class="container relative flex flex-col min-h-screen px-6 py-8 mx-auto"
      >
        <nav class="md:flex md:items-center md:justify-between">
          <div class="flex items-center justify-between">
            <button x-cloak @click="isOpen = !isOpen" class="md:hidden">
              <span x-show="isOpen">
                <svg
                  class="w-6 h-6 fill-gray-800 dark:fill-white"
              ...
              <span x-show="!isOpen">
                <svg
                  class="w-6 h-6 text-gray-800 dark:fill-white"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                >
                  <path
          ...
          <div class="flex flex-col w-full">
            ...
            >
              <span
                class="
                  ...
                  via-indigo-500
                  to-sky-500
                  dark:from-teal-200 dark:via-indigo-300 dark:to-sky-500
                "
              >
                Search a
              </span>
              ...
              <span
                class="
                  ...
                  via-pink-500
                  to-red-500
                  dark:from-sky-300 dark:via-pink-300 dark:to-red-500
                "
              >
                Movie
              </span>
            ...
            <div
              class="
                ...
                mt-8
                space-y-3
                sm:-mx-2 sm:flex-row sm:justify-center sm:space-y-0
              "
            >
              <input
                id="movie"
